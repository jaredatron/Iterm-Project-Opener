...
version 0.1
written by Jared Grippe jared@deadlyicon.com@
...
* Download Iterm-Project-Opener
** http://github.com/deadlyicon/Iterm-Project-Opener/zipball/master
* copy iTerm Project Opener.app to /Applications/
* copy sample.itermproj to you_project_name.itermproj
* edit it
* double click it
